...
export const EMPTY_TABS = {
    ...
    snoozed: {
        ...
        subHeading: "let you give messages a special time to make them easier to find. To see the schedule a message, click on the snoozed outline beside any message or conversation."
    },
    sent: {
    ...
    allmail: {
        heading: 'No Mail Available here.',
        subHeading: 'No Mails'
    }
}